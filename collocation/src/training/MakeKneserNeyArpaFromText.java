...
public class MakeKneserNeyArpaFromText
{
	...
	public static void main(final String[] argv) {
		final int lmOrder = Integer.parseInt("3");
		final String outputFile = "F:\\workspace\\collocation\\lm\\kneserNeyFromText.arpa";
		final List<String> inputFiles = new ArrayList<String>();
		inputFiles.add("F:\\workspace\\collocation\\lm\\traindata");
